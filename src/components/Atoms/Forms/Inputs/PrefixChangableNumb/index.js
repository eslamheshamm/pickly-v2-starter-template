...
export const PrefixChangableNumb = ({ label, isLabel }) => {
  return (
    <div className="flex items-center">
        ...
        >
          ...
          <div className="absolute inset-y-0 left-4 flex items-center">
            ...
            <select
              id="country-code"
              name="country-code"
              className=" focus:outline-none h-full pl- pr-2 border-transparent bg-grey bg-opacity-0 font-medium text-grey text-sm rounded-md"
            >
              <option>20</option>
              <option>01</option>
              <option>02</option>
            ...
            <div className="border-l-2 border-grey-shd6 h-4 mx-2"></div>
          </div>
          <input
            type="text"
            name="phone-number"
            id="phone-number"
            className="text-dark-grey placeholder-grey-shd1 focus:ring-1 focus:ring-dark-grey focus:text-dark focus:outline-none block w-full py-3 px-20 sm:text-sm rounded-md"
      ...
      <div className="w-3/12 opacity-50">
        <label htmlFor="phone-number" className="block text-sm text-gray-700">
          Phone Number
        </label>
        <div className="relative rounded-md border border-grey-shd5 focus:outline-none  focus:ring-2 focus:ring-primary  disabled:opacity-25">
          ...
          <input
            ...
            name="phone-number"
            id="phone-number"
            className="text-dark-grey placeholder-grey-shd1 disabled:opacity-25 block w-full py-3 px-20 sm:text-sm rounded-md"
            placeholder="Enter Text"
            autoComplete="off"
            disabled
          />
