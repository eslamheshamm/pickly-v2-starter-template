...
export const TextInputRightIcon = ({ isLabel, label, src }) => {
  return (
    <div className="flex items-center">
      <div className="w-3/12 mr-4">
        ...
        >
          <div className="absolute inset-y-0 right-4 flex items-center pointer-events-none w-4 h-auto">
      ...
      <div className="w-3/12 mr-4 opacity-50">
        ...
        <div className={cn("relative rounded-md border border-grey-shd5  ")}>
          ...
          <input
            ...
            name="phone-number"
            id="phone-number"
            className="text-dark-grey placeholder-grey-shd1  block w-full py-3 px-4 sm:text-sm rounded-md"
            placeholder="Enter Text"
            autoComplete="off"
            disabled
          />
